...
def sa_crop_classes():
    return ["Wheat", "Rye", "Barley", "Oats", "Corn", "Oil Seeds", "Root Crops", "Meadows", "Forage Crops"]

def cashew_classes():
    return ['trees/grassland', 'cashew plantations', 'cropland/others',
            'trees/grassland - cashew', 'cropland/others - cashew', 'mixed trees/grassland - cropland/others',
            'cropland/others - mixed trees/grassland']

def pastis_classes():
    return ["Background", "Meadow", "Soft winter wheat", "Corn", "Winter barley", "Winter rapeseed",
...
def tcropclass_classes():
    return ["Natural vegetation", "Forest", "Corn", "Soybeans", "Wetlands", "Developed / Barren", "Open Water", "Winter wheat",
            "Alfalfa", "Fallow / Idle Cropland", "Cotton", "Sorghum", "Other"]

def hydrosat_usa_classes():
    return ["Spring barley / Spring wheat", "Canola", "Corn", "Soybeans", "Cotton"]

def hydrosat_belgium_classes():
    return ["Winter barley", "Winter wheat", "Corn", "Sugar beets", "Potatoes"]

def hydrosat_france_classes():
    return ["Winter barley", "Winter wheat", "Winter Rapeseed", "Corn", "Sugar beets", "Potatoes"]
